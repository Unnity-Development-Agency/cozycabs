...
const About = () => {
  return (
    <>
      <head>
        <title>About CozyCabz | India’s Trusted Cab Service Platform</title>
        <meta
          name="description"
      ...
      <section className="about-hero">
        <div className="about-hero-content">
          ...
          <p>
            India’s most trusted cab service platform offering premium rides,
      ...
      <section className="info-page">
        <div className="info-container">
          <div className="info-text">
            <h2>Who We Are</h2>
            <p>
              <b>CozyCabz</b> is India’s trusted cab service platform offering
